...
// 3. ตั้งค่า Server
const app = express();
// const PORT = process.env.PORT || 3000; // Vercel จะจัดการ PORT ให้เอง เราไม่จำเป็นต้องใช้บรรทัดนี้

// 4. ตั้งค่า Middleware
app.use(cors()); 
app.use(express.json()); 

app.use(express.static('public')); // ดีมากครับ ที่มีบรรทัดนี้ Vercel จะหา index.html เจอ
...
// ---- เพิ่มบรรทัดนี้เพื่อให้ Vercel รู้จัก app ของเรา ----
module.exports = app;